...
export async function startWorkflowFromUserInput(
  ...
  const context: WorkflowContext = {
    userInput,
    input: userInput, // Alias for template compatibility
    user,
    email: user.email, // Add email for template compatibility
    ...
    try {
      switch (processedAction.type) {
        ...
        case "eden_chat_init":
          ...
          console.log(`   💬 [FlowWiseService] Eden chat initialized`);
          break;
